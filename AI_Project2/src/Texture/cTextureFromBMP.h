...
public:
	...
	bool createNewTextureFromBMPFile2(std::string textureName, std::string fileNameFullPath, bool bGenerateMIPMap);
	bool createNewCubeTextureFromBMPFiles(	std::string cubeMapName,
											std::string posX_fileName, std::string negX_fileName,
											std::string posY_fileName, std::string negY_fileName,
											std::string posZ_fileName, std::string negZ_fileName,
											bool bIsSeamless, GLenum& errorEnum, 
											std::string& errorString, std::string& errorDetails);
